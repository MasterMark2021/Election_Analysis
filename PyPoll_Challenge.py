...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        total_CountysVotes = total_CountysVotes + 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (CountysVotes > winning_CCount) and (CountysVote_percentage > winningC_percentage):
            winning_CCount = CountysVotes
            winning_county = county_name
            winningC_percentage = CountysVote_percentage
